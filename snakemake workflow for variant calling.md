...
The disk quota of my personal home directory (`/home/people/user`) was 10 GB. But luckily Computerome provided me with another directory with much larger disk quota. Therefore, 

To connect to the Computerome server, use the following command:
```
$ ssh elehos@ssh.computerome.dk
```
I changed the current working directory using this command:
```
